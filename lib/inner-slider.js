  ...
  function InnerSlider(props) {
    ...
    _defineProperty(
      ...
      function() {
        ...
        document.addEventListener("touchstart", _this.onDocumentTouchStart);
        document.addEventListener("touchend", _this.onDocumentTouchEnd);

        _this.list.addEventListener("touchstart", _this.onListTouchStart);

        _this.list.addEventListener("touchmove", _this.onListTouchMove, {
          passive: false
        });
      }
    );
    ...
    _defineProperty(
      ...
      function() {
        ...
        document.removeEventListener("touchstart", _this.onDocumentTouchStart);
        document.removeEventListener("touchend", _this.onDocumentTouchEnd);

        _this.list.removeEventListener("touchstart", _this.onListTouchStart);

        _this.list.removeEventListener("touchmove", _this.onListTouchMove, {
          passive: false
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "onListTouchStart", function(
      e
    ) {
      _this.firstClientX = e.touches[0].clientX;
    });

    _defineProperty(_assertThisInitialized(_this), "onListTouchMove", function(
      e
    ) {
